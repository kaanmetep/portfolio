...
const Button = ({
  ...
  return (
    <button
      onClick={onClick}
      type={type}
      className={`cursor-pointer border-gray-200 border lg:px-4 lg:py-2 px-2 py-1 rounded-md w-fit transition-all duration-100 lg:text-sm text-xs font-medium flex items-center justify-center ${
        dark
